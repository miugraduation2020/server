...
model = []
model1 = keras.models.load_model('ResNet50_model',custom_objects={'f1_m':f1_m,'precision_m':precision_m,'recall_m':recall_m},compile=False)
model2 = keras.models.load_model('ResNet101_model',custom_objects={'f1_m':f1_m,'precision_m':precision_m,'recall_m':recall_m},compile=False)
model3 = keras.models.load_model('DenseNet169_model',custom_objects={'f1_m':f1_m,'precision_m':precision_m,'recall_m':recall_m},compile=False)
...
load_image('D:\\Datasets\\BreaKHis 400X\\test\\malignant\\SOB_M_DC-14-2773-400-018.png')
